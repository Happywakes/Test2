...
namespace Test
{
    class Program
    {
        ...
        {//This is a horror story from many perspectives.May or may not be entertaining.
            ...
            Console.WriteLine(".");
                Console.WriteLine("Welcome to the APSGE GMO Spa! Would you like to know more?");
            ...
            else // annoyance
            {
                ...
                Console.Write("As you walk away you hear screams come from the the windows and mutated semblance of a man briefly walks in front of a window.");
